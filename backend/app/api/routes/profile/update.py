...
@router.patch("/update", response_model=Profile, status_code=status.HTTP_201_CREATED)
async def update_profile(
    ...
    try:
        ...
        logger.error(f"Failed to update a profile for the user: {current_user.email}: {e}")
        raise HTTPException(
