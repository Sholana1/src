...
from backend.app.core.utils import set_auth_cookies,create_activation_token,create_jwt_token
    ...
    try:
        ...
        if user:
            ...
            if not await user_auth_service.verify_user_password(
                ...
                remaining_attempts = (
                    settings.LOGIN_ATTEMPT - user.failed_login_attempts
                )               
                ...
                raise HTTPException(
                    ...
                    details = {
                        ...
                        "remaining_attempt": remaining_attempts
                    }
                )
...
async def verify_login_otp(verify_data: OTPVerifyRequestSchema, response:Response, session:AsyncSession = Depends(get_session)):
    try:
        ...
        raise HTTPException(
            ...
            detail={
                "status": "error",
                "message": "Failed to verify OTP request",
