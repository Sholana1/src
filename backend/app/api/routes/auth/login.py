...
from backend.app.core.utils import set_auth_cookies, create_jwt_token
...
async def request_login_otp(
    ...
    try:
            ...
            if not is_valid_password:
                ...
                if remaining_attempts > 0:
                    ...
                    error_message = (
                        ...
                        f"to too many failed attempts. Please try again after "
        ...
        logger.exception("Failed to process login OTP request")
        raise HTTPException(
...
async def verify_login_otp(
    ...
    try:
        ...
        logger.exception("Failed to verify login OTP request")
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail={
                "status": "error",
