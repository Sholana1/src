...
Revision ID: 8883a0cf0cb4
Revises: 
Create Date: 2025-12-21 06:01:17.406021
...
def upgrade() -> None:
    ...
    sa.Column('account_status', sa.Enum('ACTIVE', 'INACTIVE', 'LOCKED', 'SUSPENDED', 'PENDING_VERIFICATION', name='accountstatus'), nullable=False),
    sa.Column('role', sa.Enum('CUSTOMER', 'ADMIN', 'BRANCH_MANAGER', 'TELLER', 'ACCOUNT_EXECUTIVE', 'SUPER_ADMIN', name='rolechoiceschema'), nullable=False),
